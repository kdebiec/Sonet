...
TextFieldStyle {
    ...
    //property alias placeholderPixelSize: fieldPlaceholder.font.pixelSize
    background : Item {
        id: background
        ...
        Rectangle {
            ...
            color: background.hasError ? background.errorColor
                                    : control.activeFocus ? background.color
                                                          : control.borderColor//Theme.light.hintColor
        ...
        Label {
            ...
            font.pixelSize: placeholderPixelSize//16 * Units.dp
            anchors.margins: -12 * Units.dp
            color: background.hasError ? background.errorColor
                                  : control.activeFocus && control.text !== ""
                                        ? background.color : control.placeholderTextColor//Theme.light.hintColor
