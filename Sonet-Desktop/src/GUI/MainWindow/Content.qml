...
Item{
    ...
    Connections{
        ...
        onRefresh: {
            updateVisibleRows()
            if(
                main.content.col === (parseInt(gridLayout.width / (50 + gridLayout.columnSpacing))>= 14 ? 14 : parseInt(gridLayout.width / (50 + gridLayout.columnSpacing))) &&
                    ...
                    ListItem.Standard {
                        ...
                        onClicked: {
                            ...
                            if(!maximized)
                            {
                                ...
                                main.content.col = Qt.binding(function() { return parseInt(gridLayout.width / (50 + gridLayout.columnSpacing))>= 14 ? 14 : parseInt(gridLayout.width / (50 + gridLayout.columnSpacing))});
