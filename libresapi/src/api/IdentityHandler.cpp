    ...
    mMtx("IdentityHandler Mtx"), mStateToken(sts->getNewToken())
{
    ...
    addResourceHandler("own", this, &IdentityHandler::handleOwnRequest);
    addResourceHandler("notown", this, &IdentityHandler::handleNotOwnRequest);
...
void IdentityHandler::handleNotOwnRequest(Request & /*req*/, Response &resp)
{
    bool ok = true;
...
void IdentityHandler::handleOwnRequest(Request & /*req*/, Response &resp)
{
    bool ok = true;
